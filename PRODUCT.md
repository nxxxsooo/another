...
- Product palette, shared with the TUI: `#0A0A0A` surface, `#141414` panel, `#2D2D38` line, `#F4F4F5` text, `#7E7E8F` muted, `#6B50FF` primary violet, `#FF60FF` focus magenta, `#29D398` success mint, `#FF6B6B` coral. The TUI names these through Charmtone (Charple, Dolly, Bok, Julep, Sriracha, Malibu, Blush).
