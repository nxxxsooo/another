...
- **Compatibility adapters:** Cursor, CommandCode, CodeM, and Hermes. Preserve working adapters, but do not imply they receive end-to-end maintainer testing on every release.
